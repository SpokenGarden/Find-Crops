...
export default function GardenPlannerApp() {
  ...
  // Ensure categories are displayed initially
  useEffect(() => {
    if (cropData) {
      ...
      const predefinedCategories = filterCrops(
        cropArray,
        { cropName: "", zone: "", category: "all", sunRequirement: "all", waterNeed: "all", soilPreference: "all" }
      );

      setFilteredCrops(predefinedCategories.map((crop) => [crop.name, crop._raw || crop]));
    }
  }, [cropData]);
      ...
      <div className="gp-container">
        ...
        <div style={{ textAlign: "center", padding: "2rem" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "1rem", flexWrap: "wrap", marginTop: "1.75rem" }}>
            ...
            <button onClick={() => setScreen("tools")} style={{ padding: "0.9rem...